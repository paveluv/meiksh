...
# REQUIREMENT: SHALL-COMMAND-1110:
...
# utilities.
# REQUIREMENT: SHALL-COMMAND-1112:
# Executable utilities, regular built-in utilities, command_name s including a
# <slash> character, and any implementation-provided functions that are found
# using the PATH variable (as described in 2.9.1.4 Command Search and Execution
# ), shall be written as absolute pathnames.
# REQUIREMENT: SHALL-COMMAND-1113:
...
# just their names.
# REQUIREMENT: SHALL-COMMAND-1114:
# An alias shall be written as a command line that represents its alias
# definition.
# REQUIREMENT: SHALL-COMMAND-1115:
# Otherwise, no output shall be written and the exit status shall reflect that
# the name was not found.
# REQUIREMENT: SHALL-COMMAND-1116:
# Although the format of this string is unspecified, it shall indicate in which
# of the following categories command_name falls and shall include the
# information stated: Executable utilities, regular built-in utilities, and any
...
# used.)
# REQUIREMENT: SHALL-COMMAND-1121:
...
# returned: 0 Successful completion.
# REQUIREMENT: SHALL-ALIAS-1028:
# The following exit values shall be returned: 0 Successful completion.
