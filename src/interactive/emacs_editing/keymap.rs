...
impl EmacsFn {
    ...
    pub(crate) fn name(self) -> &'static [u8] {
        match self {
            Self::SelfInsert => b"self-insert",
            Self::BeginningOfLine => b"beginning-of-line",
            Self::EndOfLine => b"end-of-line",
            Self::ForwardChar => b"forward-char",
            Self::BackwardChar => b"backward-char",
            Self::ForwardWord => b"forward-word",
            Self::BackwardWord => b"backward-word",
            Self::ClearScreen => b"clear-screen",
            Self::PreviousHistory => b"previous-history",
            Self::NextHistory => b"next-history",
            Self::ReverseSearchHistory => b"reverse-search-history",
            Self::ForwardSearchHistory => b"forward-search-history",
            Self::YankLastArg => b"yank-last-arg",
            Self::HistorySearchBackward => b"history-search-backward",
            Self::HistorySearchForward => b"history-search-forward",
            Self::BeginningOfHistory => b"beginning-of-history",
            Self::EndOfHistory => b"end-of-history",
            Self::BackwardDeleteChar => b"backward-delete-char",
            Self::DeleteChar => b"delete-char",
            Self::KillLine => b"kill-line",
            Self::UnixLineDiscard => b"unix-line-discard",
            Self::UnixWordRubout => b"unix-word-rubout",
            Self::KillWord => b"kill-word",
            Self::BackwardKillWord => b"backward-kill-word",
            Self::Yank => b"yank",
            Self::TransposeChars => b"transpose-chars",
            Self::TransposeWords => b"transpose-words",
            Self::UpcaseWord => b"upcase-word",
            Self::DowncaseWord => b"downcase-word",
            Self::CapitalizeWord => b"capitalize-word",
            ...
            Self::EditAndExecuteCommand => b"edit-and-execute-command",
        }
    }
