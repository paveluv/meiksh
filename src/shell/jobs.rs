...
pub(super) fn try_wait_child(pid: sys::Pid) -> sys::SysResult<Option<WaitOutcome>> {
...
impl Shell {
    ...
    pub(super) fn foreground_handoff(&self, pgid: Option<sys::Pid>) -> Option<sys::Pid> {
    ...
    pub(super) fn restore_foreground(&self, saved_foreground: Option<sys::Pid>) {
