...
tests: []
spec_tested: blocked
testing_blockers: "Symlink content substitution during pathname resolution is OS kernel behavior; empty symlink and combined path length are kernel edge cases"
---
