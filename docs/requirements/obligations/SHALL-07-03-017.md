...
**Behavior:** Decimal constant representation in locale definition files: escape character followed by `d` and 2-3 decimal digits (e.g., `\d99`). Each constant is a byte value. Multi-byte characters use concatenated constants in byte order.
