...
| `GAP-BUILTIN-002` | `REQ-BUILTIN-SET-*` | `set` now has a stronger core subset, including `-a`, named `-o`/`+o`, and option-state reporting, but most remaining Issue 8 options and their exact semantics are still missing. |
